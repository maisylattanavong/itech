                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" value="{{$portfolio->portfolio_name}}" name="portfolio_name" type="text"  id="example-text-input">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" value="{{$portfolio->portfolio_title}}" name="portfolio_title" type="text"  id="example-text-input">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="image" name="portfolio_image" type="file"  id="example-text-input">
                            </div>
                        </div>
